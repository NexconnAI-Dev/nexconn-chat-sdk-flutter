...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new ai.nexconn.chat_plugin.AiNexconnChatPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin ai_nexconn_chat_plugin, ai.nexconn.chat_plugin.AiNexconnChatPlugin", e);
    }
    try {
